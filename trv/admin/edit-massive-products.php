...
<head>
	<title>Editar productos masivamente</title>
...
<body onload="startCreation()">
			...
			<div class="fade" id="step1">
				...
				<div class="columns">
					<div class="column is-two-fifths">
						<a class="button is-fullwidth backgroundDark" onclick="downloadTemplate()"><i class="fas fa-file-excel"></i> Descargar plantilla</a>
		...
		<div>
			...
			<div class="fade" id="step2" style="display: none">
				...
				<div class="has-text-centered">
					<button class="button backgroundDark" onclick="editProducts()"><i class="fas fa-circle-check"></i> Importar información</button>
	...
	<form action="/trv/admin/include/edit-massive-download-template.php" method="POST" style="display: none">
		...
		<input id="downloadTemplateSend" type="submit" value="Enviar">
	</form>
