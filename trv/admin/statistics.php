...
<body onload="getStats()">
	...
	<div class="contentBox">
		<h3 class="is-size-5">Estadísticas de ventas</h3>
		<p>Observe el crecimiento de su negocio mediante las estadísticas de ventas mensuales y diarias</p>
		...
		<div class="box">
			...
			<div class="tabs is-centered is-boxed">
				<ul>
					<li class="is-active"><a href="/trv/admin/statistics.php"><span class="icon is-small"><i class="fas fa-coins"></i></span><span>Ventas totales</span></a></li>
			...
			$.ajax({
				...
				success: function(response) {
					if (response['errores'] == true) {
						...
						document.getElementById('chartShow').innerHTML = "<p class= 'has-text-centered is-size-5'><b>No se encontraron resultados</b></p>";
