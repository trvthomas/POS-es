...
<head>
	<title>Registrar documento de ingreso de mercancía</title>
...
<body onbeforeunload="return confirmationExit()">
	...
	<div class="contentBox">
		<h3 class="is-size-5">Documento de ingreso de mercancía</h3>
		<p>Registre el ingreso de artículos y productos</p>
		...
		<div class="box">
			...
			<div class="columns has-text-centered">
				<div class="column">
					<div class="field">
						<label class="label">Motivo ingreso</label>
						<div class="control has-icons-left">
							<span class="select is-fullwidth">
								<select id="selectType">
									<option value="Recibir mercancía/Restock">Recibir mercancía/Restock</option>
									<option value="Ingreso por cambio de producto">Ingreso por cambio de producto</option>
		...
		<div class="box">
			...
			<div class="columns">
				...
				<div class="column">
					<div class="block has-text-left">
						...
						<h4 class="is-size-6 has-text-grey">Productos a ingresar</h4>
			...
			<div class="has-text-centered">
				...
				<br><a class="button is-danger is-inverted is-small" href="/trv/inventory/merchandise-entry.php"><i class="fas fa-circle-xmark"></i> Cancelar y volver a comenzar</a>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function registrarMovimiento() {
			...
			if (productsArray.length <= 0) {
				...
				newNotification('Escriba como <b>nota la razón del movimiento</b>', 'error');
			} else {
				var c = confirm("Por favor confirme esta acción. Va a registrar un ingreso de " + thousands_separators(numberProducts) + " productos.");
